...
public class OrderlinesController {
	...
	public ResponseEntity<Iterable<Orderline>> GetAll(){
		var orderlines = ordlineRepo.findAll(); // in c# we would have to use Async, await, etc
	...
	@PostMapping
	public ResponseEntity<Orderline> Insert(int id, @RequestBody Orderline orderline) throws Exception{
		if(orderline == null) {
