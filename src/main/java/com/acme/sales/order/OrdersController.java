...
public class OrdersController {
	...
	public ResponseEntity<Iterable<Order>> GetAll(){
		...
		return new ResponseEntity<Iterable<Order>>(orders, HttpStatus.OK); // in c# we would have to use Async, await, etc
	}
	...
	@PostMapping
	public ResponseEntity<Order> Insert(int id, @RequestBody Order order){
		if(order == null) {
